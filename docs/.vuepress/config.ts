...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: '努力的it小胖子', // 必需
      link: 'https://github.com/yujiale123', // 可选的
    },
    ...
    // 社交图标 (显示于博主信息栏和页脚栏。内置图标：https://doc.yujiale123.com/pages/a20ce8/#social)
    // social: {
    ...
    footer: {
      ...
      copyrightInfo:
        'Evan Xu | <a href="https://github.com/yujiale123//blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端技术和web前端技术博客,专注前后端学习与总结。争取当全栈工程师。',
      },
    ],
